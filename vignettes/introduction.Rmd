...
vignette: >
  %\VignetteIndexEntry{Introduction to budget}
...
This introductory vignette provides a brief description of the functions provided by *budget* along with some simple examples on how to construct your budget.  Please refer to the function documentation for more technical information on each of these functions.

## Deconstructing a Budget

*budget* makes it easy to extend your recurring monthly cash flow out over time.  To do this, *budget* uses three primary abstractions:
